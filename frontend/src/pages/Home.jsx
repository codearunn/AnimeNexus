    ...
    <div className="min-h-screen text-white bg-gradient-to-br from-black to-red-900">
      ...
      <section className="max-w-7xl mx-auto px-4 mt-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1 */}
          <div className="bg-black bg-opacity-50 border border-red-500 rounded-lg p-6 text-center hover:shadow-red-500/50 hover:shadow-lg hover:scale-105 transform transition-transform cursor-pointer">
